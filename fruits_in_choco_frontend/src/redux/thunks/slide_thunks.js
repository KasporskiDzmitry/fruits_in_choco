...
import {
    addSlideBegin, addSlideFailure,
    addSlideSuccess, deleteSlideBegin, deleteSlideFailure,
    fetchSlidesBegin,
    fetchSlidesFailure,
    fetchSlidesSuccess, updateSlideBegin, updateSlideFailure, updateSlideSuccess
...
export const deleteSlide = (slide) => async dispatch => {
    try {
        ...
        dispatch(deleteSlideBegin(slide.id));
        // dispatch(loadSlides());
    } catch (e) {
