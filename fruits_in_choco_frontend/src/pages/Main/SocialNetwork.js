...
export const SocialNetwork = () => {
    return (
        <div
            id={'social_networks'}
            className={`${appStyle.sectionOuter} ${style.socialNetworks}`}
        >
            <div
                className={`${appStyle.sectionInner} ${style.socialNetworksWrapper}`}
            >
                <p>
                    Подписывайтесь на нас в социальных сетях чтобы всегда быть в
                    курсе новинок, акций и розыгрышей
                </p>
